            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-4 col-sm-4 col-md-4">
                        <h1 className={`text-center ${style.mainTitle}`}>Outras notícias sobre Internacional</h1>
                        {previewNew ? (
                            <div className="card mb-2">
                                ...
                                <div className="card-body">
                                    ...
                                    <Link href={`/internacional${previewNew.uri}`}>
                                        <a>
                        ...
                        {nextNew ? (
                            <div className="card mb-2">
                                ...
                                <div className="card-body">
                                    ...
                                    <Link href={`/internacional${nextNew.uri}`}>
                                        <a>
                                            <button className={`btn btn-link btn-block ${style.readMore}`}>Leia mais</button>
                                        </a>
                                    </Link>
                        ...
                        {fourthNew ? (
                            <div className="card mb-2">
                                ...
                                <div className="card-body">
                                    ...
                                    <Link href={`/internacional${fourthNew.uri}`}>
                                        <a>
                                            <button className={`btn btn-link btn-block ${style.readMore}`}>Leia mais</button>
                                        </a>
                                    </Link>
                        ...
                        {lastNew ? (
                            <div className="card mb-2">
                                ...
                                <div className="card-body">
                                    ...
                                    <Link href={`/internacional${lastNew.uri}`}>
                                        <a>
                                            <button className={`btn btn-link btn-block ${style.readMore}`}>Leia mais</button>
                                        </a>
                                    </Link>
...
Uri.getInitialProps = async function() {
    ...
    const news = await client.query({query: fourthNew})
